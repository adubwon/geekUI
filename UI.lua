...
function Luxt1.CreateWindow(libName, logoId)
    ...
    local playerPfp = Instance.new("ImageLabel") -- Added player profile picture
    local MainCorner_5 = Instance.new("UICorner") -- Added for pfp corner
    ...
    playerPfp.Parent = sideHeading
    playerPfp.BackgroundColor3 = Color3.fromRGB(21, 21, 21)
    playerPfp.Position = UDim2.new(0.058, 0, 0.09, 0)
    playerPfp.Size = UDim2.new(0, 28, 0, 28)
    playerPfp.ZIndex = 2
    playerPfp.Image = "https://www.roblox.com/headshot-thumbnail/image?userId="..localPlayer.UserId.."&width=420&height=420&format=png"
    playerPfp.BackgroundTransparency = 1
    
    MainCorner_5.CornerRadius = UDim.new(0, 999)
    MainCorner_5.Name = "MainCorner"
    MainCorner_5.Parent = playerPfp
    ...
    tabFrame.Position = UDim2.new(0.0761478543, 0, 0.176385808, 0) -- Adjusted position for pfp
    tabFrame.Size = UDim2.new(0, 135, 0, 317) -- Adjusted size for pfp
    tabFrame.ZIndex = 2
    ...
    usename.Position = UDim2.new(0.290000081, 0, 0.0950000152, 0) -- Adjusted position for pfp
